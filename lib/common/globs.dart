...
class Globs {
  ...
  static SharedPreferences? prefs; // Define prefs at the class level
  ...
  // Call this function before using any SharedPreferences methods
...
class SVKey {
  static const mainUrl = "http://192.168.168.39:3001";
